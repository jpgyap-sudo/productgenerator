 ...
 */
export async function uploadRendersToDrive(itemId, productName, views) {
  ...
  const uploadPromises = views.map(view =>
    uploadViewWithRetry(drive, view, folderName, folderId)
  );
