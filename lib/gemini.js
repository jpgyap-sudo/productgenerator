...
export async function generateGeminiView(view, desc, imageUrl, resolution = '1K', brand = '', options = {}) {
  ...
  // forceFlash: always use Flash even for view 4 (used by fallback strategy)
  const modelName = (view.id === 4 && !options.forceFlash) ? GEMINI_MODELS.PREMIUM : GEMINI_MODELS.STANDARD;
