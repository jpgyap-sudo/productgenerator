...
//    (faster, cheaper batch/preview model)
//  - View 5 (interior scene): gemini-2.5-pro
 ...
 * The user requested:
 *   - gemini-2.0-flash-image-generation for views 1-4 (batch/preview)
 *   - gemini-2.5-pro for view 5 (premium)
 */
const GEMINI_MODELS = {
  STANDARD: 'gemini-2.0-flash-image-generation', // Views 1-4
  PREMIUM: 'gemini-2.5-pro'                      // View 5 (interior scene)
};
 ...
 *
 * For views 1-4, uses gemini-2.0-flash-image-generation (faster/cheaper).
 * For view 5, uses gemini-2.5-pro (premium model for complex scenes).
 *
